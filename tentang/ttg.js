...
// ==========================================
// 2. DATA GALLERY (DIRECT LINK GOOGLE DRIVE)
// ==========================================
const galleryData = [
    "https://lh3.googleusercontent.com/d/1BOXstI2sH5Gr3Y1V5854JCbP_618sLda",
    "https://lh3.googleusercontent.com/d/1ANEk9O2T6e6VkB_Lj2AiB9ZLUl0uUiPP",
    "https://lh3.googleusercontent.com/d/15QGGsKLFKfUz8F6pKq2ENcRHiZwbX6Aw",
    "https://lh3.googleusercontent.com/d/1x1yOxNrPzWHvs4f4BKQ42hBGiw0hVtCl"
];
...
function updateAutoContent() {
    ...
    // Update Gallery
    if (galleryFade) {
        galleryFade.innerHTML = `<img src="${galleryData[galleryIndex]}" class="fade-anim" style="width:100%; height:100%; object-fit:cover;">`;
